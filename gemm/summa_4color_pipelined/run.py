...
# SUMMA Matrix Multiplication with 4-Color Alternating Pipeline
#
# Host program to:
...
print(f"SUMMA with 4-Color Alternating Pipeline")
...
sym_A = runner.get_id("A_tile")
sym_B = runner.get_id("B_tile")
sym_C = runner.get_id("C_tile")
